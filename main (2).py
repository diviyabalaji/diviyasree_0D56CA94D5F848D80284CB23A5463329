...
cannot be accessed directly from outside the class. Write a program to create
an instance of the BankAccount class and test the deposit and withdrawal functionality'''
class BankAccount:
def __init__(self, account_number, account holder_name, initial_balance=0.0):
...
self.__account_holder_name, self.___account_number,
...
account.display_balancaccount.deposit(500.0)
